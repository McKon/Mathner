...
namespace Mathner {
	...
	class MATHNER_API Input
	{
	public:
		inline static bool IsKeyPressed(int keycode) { return s_Instance->IsKeyPressedImpl(keycode); };
		inline static float IsMouseButtonPressed(int button) { return s_Instance->IsMouseButtonPressedImpl(button); };

		inline static float GetMouseX(int keycode) { return s_Instance->GetMouseXImpl(); };
		inline static float GetMouseY(int keycode) { return s_Instance->GetMouseYImpl(); };
